...
router.post('/update-folders', UserCtrl.checkAuth, catchError(MaterialCtrl.updateFolders));
router.post('/remove-folders', UserCtrl.checkAuth, catchError(MaterialCtrl.removeFolders));
