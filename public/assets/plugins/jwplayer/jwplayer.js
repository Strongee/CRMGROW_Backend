/*!
   JW Player version 8.10.1
   Copyright (c) 2019, JW Player, All Rights Reserved 
   This source code and its use and distribution is subject to the terms 
   and conditions of the applicable license agreement. 
   https://www.jwplayer.com/tos/
   This product includes portions of other software. For the full text of licenses, see
   https://ssl.p.jwpcdn.com/player/v/8.10.1/notice.txt
*/
window.jwplayer = (function (t) {
    ...
    var r = n(18),
      ...
      S = function (t, e, n, r) {
        ...
        if ((null == t && (t = []), p && t.reduce === p))
          return r && (e = $(e, r)), i ? t.reduce(e, n) : t.reduce(e);
        if (
          (k(t, function (t, o, u) {
      ...
      W = function (t, e) {
        return (
          null != t && (t.length !== +t.length && (t = ut(t)), K(t, e) >= 0)
        );
      },
      X = W,
      U = function (t, e) {
      ...
      K = function (t, e, n) {
        ...
        var r = 0,
          i = t.length;
        if (n) {
          if ('number' != typeof n) return t[(r = H(t, e))] === e ? r : -1;
  ...
  function (t, e, n) {
    ...
    function v() {
      return (
        i(/\s(?:(?:Headless)?Chrome|CriOS)\//i) && !p() && !i(/UCBrowser/i)
      );
    }
    function g() {
      return p() || c() || h();
                ...
                (p = n
                  ...
                  .then(
                    function (t) {
                      ...
                      var e = n(22).default;
                      return (
                        (a.a.controls = n(21).default),
                        Object(u.a)(n(51).default),
                        e
                      );
                    }.bind(null, n)
                  )
  ...
  function (t, e, n) {
    ...
    var r = n(27),
      ...
      a = n(8),
      c = n(36),
      s = Object(u.m)(r.a, Object(u.C)({ name: 'html5' })),
      l = s.supports;
    function f(t) {
    ...
    function d(t) {
      ...
      var r =
          ...
          i.Browser.firefox ||
          i.Browser.edge ||
          (i.Browser.ie && 11 === i.Browser.version.major),
        o = i.OS.android && !1 === t.hlsjsdefault,
        u = i.Browser.safari && !!t.safarihlsjs;
      return (
        f(t.mediaTypes || ['video/mp4;codecs="avc1.4d400d,mp4a.40.2"']) &&
        (r || u) &&
        !o
      );
    }
    (s.supports = function (t, e) {
      ...
      if (n && t.drm && 'hls' === t.type) {
        ...
        if (r && t.drm.fairplay) {
          ...
          return (
            i &&
            i.isTypeSupported &&
            i.isTypeSupported('com.apple.fps.1_0', 'video/mp4')
          );
        }
        return r;
      }
      ...
      r.a.push({
        ...
        supports: function (t) {
          return (
            !(t.drm && !Object(c.a)(t.drm)) &&
            !(!window.HTMLVideoElement || !window.MediaSource) &&
            f(t.mediaTypes) &&
            ('dash' === t.type ||
              'mpd' === t.type ||
              (t.file || '').indexOf('mpd-time-csf') > -1)
          );
        },
      }),
      r.a.splice(0, 0, {
        name: 'hlsjs',
        supports: function (t) {
          return !(t._hlsjsProgressive && !i.Browser.ie) && d(t);
        },
      }),
      r.a.splice(1, 0, {
        name: 'hlsjsProgressive',
        supports: function (t) {
          return d(t) && !i.Browser.ie;
        },
      }),
      r.a.push({
        name: 'flash',
  ...
  function (t, e, n) {
    ...
    var r = n(31),
      ...
      u = function () {
        var t = '//ssl.p.jwpcdn.com/player/v/8.10.1/',
  ...
  function (t, e, n) {
    ...
    (f.setupPlugin = function (t) {
      ...
      return e
        ? (e.url !== t &&
            Object(c.a)(
              'JW Plugin "'
                .concat(Object(i.b)(t), '" already loaded from "')
    ...
    function v(t, e) {
      var n = t.get('plugins');
      return (
        (window.jwplayerPluginJsonp = h),
        (t.pluginLoader = t.pluginLoader || new u())
          .load(e, p, n, t)
          .then(function (e) {
  ...
  function (t, e, n) {
    ...
    e.b = function (t) {
      ...
      try {
        var s = Object(r.a)(
          t || '',
          Object(o.a)('NDh2aU1Cb0NHRG5hcDFRZQ==')
        ).split('/');
        if (
          ('pro' === (e = s[0]) && (e = 'premium'),
  ...
  function (t, e, n) {
    ...
    function w(t, e, n) {
      ...
      if (
        ...
        return (
          t.responseXML || (t = Object(r.k)({}, t, { responseXML: e })),
          n.oncomplete(t)
        );
      j(n, u.o, h);
    }
  ...
  function (t, e, n) {
    ...
    var r = n(0),
      ...
      o = function (t) {
        if (t && t.file)
          return Object(r.k)({}, { kind: 'captions', default: !1 }, t);
      },
      u = Array.isArray;
    e.a = function (t) {
  ...
  function (t, e, n) {
    ...
    function d(t, e, n) {
      ...
      if (
        ...
        return (a.file = a.sources[0].file), (a.feedData = n), a;
    }
    var p = function (t, e) {
  ...
  function (t, e, n) {
    ...
    var r =
      '8.10.1+commercial_v8-10-1.341.commercial.aae4098.hlsjs..hlsjsprogressive..jwplayer.3860509.dai.45542e3.freewheel.556af86.googima.790cdb4.vast.0bfdd06.analytics.eea14bb.gapro.141397a';
  },
  function (t, e, n) {
    'use strict';
    var r = n(0),
          ...
          c = function (e) {
            if (t.dragged) L(t, i.s, e);
              ...
              var r = D(e),
                ...
                c = u - t.startY;
              a * a + c * c > k * k &&
                (L(t, i.u, e), (t.dragged = !0), L(t, i.s, e));
            }
            n || 'touchmove' !== e.type || R(e);
          },
          s = function (n) {
            if ((clearTimeout(h), t.el))
              if ((I(t), M(t, y), t.dragged)) (t.dragged = !1), L(t, i.t, n);
              else if (
                ...
                !(function (t, e, n) {
                  ...
                  o
                    ? L(t, i.n, n)
                    : (L(t, i.sb, n), 'touchend' !== n.type || w || R(n));
              }
          };
        b
  ...
  function (t, e, n) {
    ...
    function o(t) {
      for (var e = [], n = 0; n < Object(r.c)(t); n++) {
        ...
        'jwplayer' === i.prefix &&
          'mediatypes' === Object(r.b)(i).toLowerCase() &&
          e.push(Object(r.d)(i));
      }
      return e;
    }
        ...
        for (var s = 0; s < Object(r.c)(e); s++) {
          ...
          if ('media' === l.prefix) {
            ...
            switch (Object(r.b)(l).toLowerCase()) {
              case 'content':
                if (
                  (Object(i.j)(l, 'duration') &&
                    (n.duration = Object(i.g)(Object(i.j)(l, 'duration'))),
                  Object(i.j)(l, 'url'))
                ) {
                  n.sources || (n.sources = []);
                  var f = {
    ...
    function o(t, e) {
      ...
      for (
        var n,
          ...
          u,
          a = i(Object(r.a)(t)),
          c = i(((n = e), unescape(encodeURIComponent(n))).slice(0, 16)),
          s = a.length,
          l = a[s - 1],
          f = a[0],
          d = 2654435769 * Math.floor(6 + 52 / s);
        d;
      ...
      function e(e) {
        try {
          ...
          if (c) {
            ...
            if (
              ('xml' === Object(o.b)(l) && (l = l.nextSibling),
              'rss' === Object(o.b)(l))
            ) {
              var d = Object(u.a)(l);
  ...
  function (t, e, n) {
    ...
    var d = function (t, e) {
        ...
        if (g) {
          ...
          Array.isArray(g) && (b = g),
            (b = b
              .filter(function (t) {
                return Object(r.w)(t) && t >= 0.25 && t <= 4;
              })
              .map(function (t) {
        ...
        var j = h.liveTimeout;
        null !== j &&
          (Object(r.A)(j) ? 0 !== j && (j = Math.max(30, j)) : (j = null),
          (h.liveTimeout = j));
        var w,
          O,
        ...
        return (
          (h.bandwidthEstimate = Object(r.A)(k)
            ? k
            : ((w = h.defaultBandwidthEstimate),
              (O = parseFloat(w)),
              Object(r.A)(O) ? Math.max(O, 1) : f.bandwidthEstimate)),
          (h.bitrateSelection = Object(r.A)(C) ? C : f.bitrateSelection),
          (h.backgroundLoading = Object(r.s)(h.backgroundLoading)
            ? h.backgroundLoading
    ...
    function j(t) {
      return (
        'string' == typeof t &&
        /^\/\/(?:content\.jwplatform|cdn\.jwplayer)\.com\//.test(t)
      );
    }
    function w(t) {
      return 'https:' + t;
    ...
    function O(t) {
      var e = 'file:' === window.location.protocol ? 'https:' : '',
        n = {
          jwpsrv: '//ssl.p.jwpcdn.com/player/v/8.10.1/jwpsrv.js',
          dai: '//ssl.p.jwpcdn.com/player/plugins/dai/v/0.4.9/dai.js',
          vast: '//ssl.p.jwpcdn.com/player/plugins/vast/v/8.6.6/vast.js',
          googima:
            '//ssl.p.jwpcdn.com/player/plugins/googima/v/8.6.5/googima.js',
          freewheel:
            '//ssl.p.jwpcdn.com/player/plugins/freewheel/v/2.2.6/freewheel.js',
    ...
    var C = function (t, e) {
        ...
        if (
          ...
          (o.edition = s),
          (o.error = c.error()),
          (o.generateSEOMetadata = o.generateSEOMetadata || !1),
          'unlimited' === s)
        ) {
        ...
        if (
          ((o.flashplayer = (function (t) {
            var e = t.flashplayer;
            return (
              e ||
                (e =
                  (Object(u.getScriptPath)('jwplayer.js') || t.base) +
                  'jwplayer.flash.swf'),
          ...
          Object(r.y)(i) &&
            i.indexOf(g) > -1 &&
            ((o.playlist = (function (t, e) {
              var n = (t.querySelector('title') || {}).textContent,
                r = b(t, 'meta[property="og:title"]'),
                i = encodeURIComponent(r || n || ''),
                o =
                  b(t, 'meta[property="og:description"]') ||
                  b(t, 'meta[name="description"]');
              return (
            ...
            (o.contextual = !0)),
          Object(p.isFileProtocol)())
        ) {
          var m = o,
            C = m.playlist,
            P = m.related;
          j(C) && (o.playlist = w(C)), P && j(P.file) && (P.file = w(P.file));
        }
        return o;
      },
      P = n(10),
    ...
    function R(t) {
      ...
      if (n && n.code === h.a) {
        ...
        if (i > 0 && i < 4 && r && o.duration() > -7776e6)
          return new A.a('//content.jwplatform.com/libraries/'.concat(r, '.js'))
            .load()
            .then(function () {
              ...
              n.error() ||
                n.token() !== o.token() ||
                ((e.key = t), (e.edition = n.edition()), (e.error = n.error()));
            })
            .catch(function () {});
      }
    ...
    var q = function (t) {
      ...
      z = function (t) {
        var e = t.attributes,
          ...
          o = e.intl,
          u = Object(l.c)(i, o, n);
        return !Object(l.h)(n) || Object(l.f)(u)
          ? Promise.resolve()
          : new Promise(function (i) {
              return Object(l.i)(r, n)
                .then(function (n) {
                  var r = n.response;
                  if (!I(t)) {
    ...
    var V = function (t) {
        ...
        (this.start = function (n) {
          var r = Object(x.a)(t, n),
            i = Promise.all([Object(P.d)(t), r, L(t), D(t), q(t), z(t)]),
    ...
    var it = function (t) {
      (this._events = {}),
        (this.modelShim = new J.a()),
        (this.modelShim._qoeItem = new H.a()),
        (this.mediaShim = {}),
        (this.setup = new V(this.modelShim)),
    ...
    function ot(t, e) {
      e &&
        ...
        console.error(_.s.logMessage(e.code)));
    }
    function ut(t) {
    ...
    Object(r.k)(it.prototype, {
      ...
      init: function (t, e) {
        var n = this,
          ...
          u = o && o.getAllItems();
        (i.attributes = i.attributes || {}), Object(r.k)(this.mediaShim, K.a);
        var a = t,
          c = C(Object(r.k)({}, t), u);
        (c.id = e.id),
          (c.setupConfig = a),
          Object(r.k)(i.attributes, c, K.b),
          (i.getProviders = function () {
            return new Q.a(c);
          }),
          (i.setProvider = function () {});
        var s = (function () {
          for (var t = G.c, e = [], n = [], r = 0; r < t; r++) {
            var i = et();
            e.push(i), n.push(i), tt(i);
          }
          var o = n.shift(),
            u = n.shift(),
            a = !1;
        ...
        i.get('backgroundLoading') ||
          (s = Object(nt.a)(s.getPrimedElement(), s));
        var l = new rt.a(Object(rt.b)(this.originalContainer)).once(
          'gesture',
          function () {
          ...
          this.setup
            ...
            .then(function (t) {
              ...
              if (n.setup) {
                ...
                var l = n._model;
                return (
                  i.off('change:errorEvent', ot),
                  l.on('change:errorEvent', ot),
                  o.track(l),
                  n
      ...
      playerDestroy: function () {
        this.apiQueue && this.apiQueue.destroy(),
          ...
          this.currentContainer !== this.originalContainer &&
            at(this, this.originalContainer),
          this.off(),
    ...
    function d() {
      u.forEach(function (t) {
        ...
        if (
          ...
          !i && 'paused' === n && t.api.getFullscreen()
            ? t.api.setFullscreen(!1)
            : 'playing' === n && t.api.setFullscreen(i);
        }
      });
    }
    function p() {
    ...
    var f = (function () {
      function t(e, n, i) {
        ...
        var a = { display: 'block', position: 'absolute', top: 0, left: 0 },
          ...
          p = d.firstChild,
          h = d.nextSibling;
        Object(u.d)([d, h], Object(r.k)({ overflow: 'auto' }, a, s)),
  ...
  function (t, e, n) {
    ...
    Object(r.k)(Q.prototype, {
      ...
      trigger: function (t, e) {
        return (
          ((e = r.g.isObject(e) ? Object(r.k)({}, e) : {}).type = t),
    ...
    var H = function (t) {
      ...
      if (
        (t
          ? 'string' == typeof t
            ? (e = W(t)) || (n = document.getElementById(t))
            : 'number' == typeof t
            ? (e = v.a[t])
            : t.nodeType &&
              (e = W((n = t).id || n.getAttribute('data-jwplayer-id')))
          : (e = v.a[0]),
        e)
      )
        return e;
    ...
    function ot(t) {
      var e = {};
      ut(this, t, t, e), ut(this, t, Q.prototype, e);
    }
    function ut(t, e, n, r) {
      var i = Object.keys(n);
        ...
        'function' == typeof n[o] && 'Events' !== o
          ? (t[o] = (function t(e, n, r, i, o) {
              return function () {
                ...
                if ((l || c.push([r, a]), s)) return st(n, c), n[r].apply(e, u);
                !(function (t, e) {
                  var n = {
    ...
    function at(t) {
      console.warn(
        'The API method jwplayer().'.concat(
          t,
...
var jwDefaults = {
  ...
  displaytitle: true,
  flashplayer: '//ssl.p.jwpcdn.com/player/v/8.10.1/jwplayer.flash.swf',
  ga: {
    idstring: 'title',
  },
  height: 260,
  key: 'jN4gsKgT0jrpOEE2VDpB65FhnyUjxhqVIXhfQ3uUKMozRJjLU8aAt3fmOsA=',
  mute: false,
  ph: 1,
  pid: 'LJ361JYj',
  preload: 'metadata',
  ...
  sharing: {
    code:
      '%3Ciframe%20src%3D%22//content.jwplatform.com/players/MEDIAID-LJ361JYj.html%22%20width%3D%22320%22%20height%3D%22260%22%20frameborder%3D%220%22%20scrolling%3D%22auto%22%3E%3C/iframe%3E',
    heading: 'Share this Movie',
