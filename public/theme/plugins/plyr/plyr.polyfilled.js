typeof navigator === 'object' &&
  ...
  */
    ...
    var arrayMethodUsesToLength = function (METHOD_NAME, options) {
      ...
      return (cache[METHOD_NAME] =
        ...
        !fails(function () {
          ...
          if (ACCESSORS)
            defineProperty$3(O, 1, { enumerable: true, get: thrower });
          else O[1] = 1;
    ...
    var getIteratorMethod = function (it) {
      if (it != undefined)
        return it[ITERATOR$5] || it['@@iterator'] || iterators[classof(it)];
    };
    ...
    (function (global) {
      ...
      var polyfillURL = function polyfillURL() {
        ...
        var linkURLWithAnchorAttribute = function linkURLWithAnchorAttribute(
          attributeName
        ) {
    ...
    _export(
      { target: 'Number', proto: true, forced: FORCED$1 },
      {
        // eslint-disable-next-line max-statements
    ...
    var isEmpty = function isEmpty(input) {
      return (
        ...
        ((isString(input) || isArray$1(input) || isNodeList(input)) &&
          !input.length) ||
    ...
    var queueMicrotaskDescriptor = getOwnPropertyDescriptor$3(
      global_1,
      'queueMicrotask'
    );
    var queueMicrotask =
    ...
    var onUnhandled = function (promise, state) {
      task$1.call(global_1, function () {
        ...
        if (IS_UNHANDLED) {
          ...
          state.rejection =
            IS_NODE$1 || isUnhandled(state) ? UNHANDLED : HANDLED;
            ...
            { global: true, enumerable: true, forced: true },
            {
              ...
              fetch: function fetch(input /* , init */) {
                return promiseResolve(
                  PromiseConstructor,
                  $fetch$1.apply(global_1, arguments)
                );
              },
            }
          );
    ...
    var MDN_POLYFILL_BUG =
      ...
      !!(function () {
        var descriptor = getOwnPropertyDescriptor$4(
          String.prototype,
          'startsWith'
        );
    ...
    var isEmpty$1 = function isEmpty(input) {
      return (
        ...
        ((isString$1(input) || isArray$2(input) || isNodeList$1(input)) &&
          !input.length) ||
      ...
      setup: function setup() {
        ...
        Object.defineProperty(player.media, 'quality', {
          ...
          set: function set(input) {
            ...
            if (
              player.config.quality.forced &&
              is$1.function(player.config.quality.onChange)
            ) {
    ...
    if (FORCED$3) {
      var RegExpWrapper = function RegExp(pattern, flags) {
        ...
        if (UNSUPPORTED_Y$2 && sticky)
          setInternalState$7(result, { sticky: sticky });
    ...
    var controls = {
      ...
      updateSeekTooltip: function updateSeekTooltip(event) {
        ...
        var toggle = function toggle(show) {
          return toggleClass(
            _this5.elements.display.seekTooltip,
            visible,
            show
          );
        }; // Hide on touch
        ...
        function Fullscreen(player) {
          ...
          on.call(
            ...
            function (event) {
              ...
              if (
                is$1.element(_this.player.elements.controls) &&
                _this.player.elements.controls.contains(event.target)
              ) {
                return;
              }
          ...
          on.call(this, this.player.elements.container, 'keydown', function (
            event
          ) {
          ...
          [
            ...
            },
            {
              ...
              value: function toggleFallback() {
                ...
                if (browser.isIos) {
                  var viewport = document.head.querySelector(
                    'meta[name="viewport"]'
                  );
                  ...
                  var hasProperty =
                    is$1.string(viewport.content) &&
                    viewport.content.includes(property);
    ...
    var ui = {
      ...
      checkPlaying: function checkPlaying(event) {
        ...
        Array.from(this.elements.buttons.play || []).forEach(function (target) {
          ...
          target.setAttribute(
            'aria-label',
            i18n.get(_this3.playing ? 'pause' : 'play', _this3.config)
          );
        ...
        _createClass(Listeners, [
          ...
          },
          {
            ...
            value: function controls$1() {
              ...
              this.bind(elements.progress, 'mousemove touchmove', function (
                event
              ) {
              ...
              this.bind(elements.progress, 'mousedown touchstart', function (
                event
              ) {
                var previewThumbnails = player.previewThumbnails;
              ...
              this.bind(elements.progress, 'mouseup touchend', function (
                event
              ) {
                var previewThumbnails = player.previewThumbnails;
    ...
    var USES_TO_LENGTH$a = arrayMethodUsesToLength('splice', {
      ACCESSORS: true,
      0: 0,
      1: 2,
    });
    ...
    var vimeo = {
      setup: function setup() {
        ...
        toggleClass(
          ...
          player.config.classNames.embed,
          true
            ...
            value: function onAdEvent(event) {
              ...
              var dispatchEvent = function dispatchEvent(type) {
                triggerEvent.call(
                  _this8.player,
                  _this8.player.media,
                  'ads'.concat(type.replace(/_/g, '').toLowerCase())
                );
              }; // Bubble the event
    ...
    var USES_TO_LENGTH$c = arrayMethodUsesToLength('indexOf', {
      ACCESSORS: true,
      1: 0,
    });
    ...
    var arrayLastIndexOf = FORCED$4
      ? function lastIndexOf(searchElement /* , fromIndex = @[*-1] */) {
          ...
          var index = length - 1;
          if (arguments.length > 1)
            index = min$6(index, toInteger(arguments[1]));
        ...
        _createClass(PreviewThumbnails, [
          ...
          },
          {
            ...
            value: function startScrubbing(event) {
              ...
              if (
                is$1.nullOrUndefined(event.button) ||
                event.button === false ||
                event.button === 0
              ) {
              ...
              return new Promise(function (resolve) {
                setTimeout(function () {
                  ...
                  if (_this9.showingThumbFilename === oldThumbFilename) {
                    ...
                    if (forward) {
                      thumbnailsClone = _this9.thumbnails[0].frames.slice(
                        thumbNum
                      );
                    } else {
            ...
            value: function toggleThumbContainer() {
              ...
              var clearShowing =
                arguments.length > 1 && arguments[1] !== undefined
                  ? arguments[1]
                  : false;
              var className = this.player.config.classNames.previewThumbnails
                .thumbContainerShown;
          ...
          },
          {
            ...
            value: function setImageSizeAndOffset(previewImage, frame) {
              ...
              previewImage.style.height = ''.concat(
                previewImage.naturalHeight * multiplier,
                'px'
              ); // eslint-disable-next-line no-param-reassign

              previewImage.style.width = ''.concat(
                previewImage.naturalWidth * multiplier,
                'px'
              ); // eslint-disable-next-line no-param-reassign
        ...
        this.destroy.call(
          ...
          function () {
            ...
            if (!is$1.empty(input.previewThumbnails)) {
              Object.assign(
                _this2.config.previewThumbnails,
          ...
          [
            ...
            },
            {
              ...
              value: function rewind(seekTime) {
                this.currentTime -= is$1.number(seekTime)
                  ? seekTime
