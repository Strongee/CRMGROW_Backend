  ...
  (function (e, t) {
    ...
    var n = function (e) {
      ...
      v = function (e, t) {
        if (!g(e)) return e;
        var n, i;
        if (t && 'function' == typeof (n = e.toString) && !g((i = n.call(e))))
          return i;
    ...
    var J,
      ...
      Se = function (e, t) {
        var n = Ae[Ee(e)];
        return n == Ce || (n != xe && ('function' == typeof t ? r(t) : !!t));
      },
        ...
        if ((n = c ? i : u ? i[l] || O(l, {}) : (i[l] || {}).prototype))
          for (r in t) {
            if (
              ...
              !Pe(c ? r : l + (u ? '.' : '#') + r, e.forced) && void 0 !== a)
            ) {
    ...
    var Be =
      ...
      Xe = function (e) {
        return (
          b($e, e) ||
            (Le && b(Ye, e) ? ($e[e] = Ye[e]) : ($e[e] = Ge('Symbol.' + e))),
          $e[e]
        );
      },
      Qe = { f: Xe },
      ...
      Nt = function (e) {
        ...
        return (
          ...
          (!(n || !b(this, t) || !b(Tt, t) || (b(this, ht) && this[ht][t])) ||
            n)
        );
      },
      Rt = function (e, t) {
        ...
        if (n !== mt || !b(Tt, i) || b(St, i)) {
          var r = yt(n, i);
          return (
            !r || !b(Tt, i) || (b(n, ht) && n[ht][i]) || (r.enumerable = !0), r
          );
        }
      },
      _t = function (e) {
      ...
      (Le ||
        (ee(
          (gt = function () {
            ...
            return a && Pt && It(mt, t, { configurable: !0, set: n }), Ot(t, e);
          }).prototype,
          'toString',
          function () {
            return pt(this).tag;
        ...
        if (
          (g &&
            ...
            xn !== Object.prototype &&
              s.next &&
              (yn(s) !== xn &&
                (An ? An(s, xn) : 'function' != typeof s[Pn] && I(s, Pn, In)),
              nt(s, h, !0))),
          'values' == r &&
            p &&
            'values' !== p.name &&
        ...
        return (
          ...
          o
            ? i
              ...
              : (a.lastIndex = 0)
            : ui && i && (a.lastIndex = a.global ? i.index + i[0].length : t),
          fi &&
            i &&
            i.length > 1 &&
    ...
    var di = ci;
    Oe({ target: 'RegExp', proto: !0, forced: /./.exec !== di }, { exec: di });
    ...
    On(
      ...
      function () {
        ...
        return i >= n.length
          ? { value: void 0, done: !0 }
          : ((e = wi(n, i)), (t.index += e.length), { value: e, done: !1 });
      }
    );
    var Si = Xe('species'),
      Ei = !r(function () {
    ...
    Ii('search', 1, function (e, t, n) {
      return [
        ...
        function (e) {
          ...
          var s = ji(r, a);
          return (
            Fi(r.lastIndex, o) || (r.lastIndex = o), null === s ? -1 : s.index
          );
        },
      ];
    });
          ...
          [
            ...
            function (e, r) {
              ...
              for (var d = 0, p = 0, m = []; p < s.length; ) {
                ...
                if (
                  null === v ||
                  (g = zi(le(h.lastIndex + (Wi ? 0 : p)), s.length)) === d
                )
                  p = Li(s, p, c);
                else {
    ...
    var ir = Xe('iterator'),
      ...
      lr =
        ...
        r(function () {
          ...
          ? function (e, t) {
              for (
                var n = Ne(e), i = arguments.length, r = 1, o = be.f, s = l.f;
                i > r;
      ...
      Wr = function () {
        ...
        if (
          ...
          if (g(c))
            ...
            else for (l in c) b(c, l) && h.push({ key: l, value: c[l] + '' });
          else
            Hr(
              h,
              'string' == typeof c
    ...
    Er(
      Kr,
      {
        ...
        get: function (e) {
          Vr(arguments.length, 1);
          for (var t = Or(this).entries, n = e + '', i = 0; i < t.length; i++)
                ...
                arguments.length > 1 &&
                  ...
                  g(t) &&
                    ...
                    'URLSearchParams' === ni(n) &&
                      ((i = t.headers ? new Cr(t.headers) : new Cr()).has(
                        'content-type'
                      ) ||
                        i.set(
                          'content-type',
        ...
        for (
          ...
          switch (((a = r[u]), c)) {
              ...
              if (a && (ra.test(a) || '+' == a || '-' == a || '.' == a))
                ...
                (h = ''),
                  'file' == e.scheme
                    ...
                    : '/' == r[u + 1]
                    ? ((c = Ra), u++)
                    : ((e.cannotBeABaseURL = !0), e.path.push(''), (c = Ga));
              }
              break;
            case Ma:
            ...
            case Ua:
              ...
              break;
            case Fa:
              if (((c = Da), '/' != a || '/' != h.charAt(u + 1))) continue;
              u++;
              break;
            case Da:
              if ('/' != a && '\\' != a) {
            ...
            case za:
              if (((e.scheme = 'file'), '/' == a || '\\' == a)) c = Wa;
                ...
                if (a == $r)
                  ...
                  if ('#' != a) {
                    Pa(r.slice(u).join('')) ||
                      ((e.host = i.host), (e.path = i.path.slice()), Ia(e)),
                      (c = Ya);
                    continue;
                  }
                  (e.host = i.host),
      ...
      (a &&
        _e(eo, {
          ...
          port: po(lo, function (e) {
            var t = ea(this);
            xa(t) || ('' == (e = String(e)) ? (t.port = null) : Ja(t, e, Va));
          }),
              ...
              n
                ? {
                    get: function (e) {
                      ...
                      if (g(e)) {
                        var n = bs(e);
                        return !0 === n ? As(t).get(e) : n ? n[t.id] : void 0;
                      }
                    },
                    set: function (e, t) {
                      return o(this, e, t);
              ...
              set: function (e, i) {
                if (g(e) && !o(e)) {
                  ...
                  r.frozen || (r.frozen = new t()),
                    h.call(this, e) ? d.call(this, e, i) : r.frozen.set(e, i);
          ...
          var t,
            ...
            d = function () {
              for (var e = 6, t = ''; --e >= 0; )
                if ('' !== t || 0 === e || 0 !== s[e]) {
                  var n = String(s[e]);
                  t = '' === t ? n : t + _s.call('0', 7 - n.length) + n;
                }
              return t;
            };
    ...
    var Hs = l.f,
      Bs = function (e) {
        return function (t) {
          for (var n, i = m(t), r = Re(i), o = r.length, s = 0, l = []; o > s; )
            (n = r[s++]), (a && !Hs.call(i, n)) || l.push(e ? [n, i[n]] : i[n]);
          return l;
        };
      },
    ...
    var Wl,
      ...
      mc = Pe(nc, function () {
        ...
        return (
          ((e.constructor = {})[tc] = t), !(e.then(function () {}) instanceof t)
        );
      }),
      gc =
        mc ||
        ...
        if (!t.notified) {
          ...
          Gl(function () {
            for (var r = t.value, a = 1 == t.state, o = 0; i.length > o; ) {
              ...
              try {
                h
                  ? (a || (2 === t.rejection && Tc(e, t), (t.rejection = 1)),
                    !0 === h
                      ? (s = r)
                      : (p && p.enter(), (s = h(r)), p && (p.exit(), (c = !0))),
                    s === u.promise
    ...
    var xc,
      ...
      Oc = ms('startsWith'),
      Lc = !(
        Oc || ((xc = Cc(String.prototype, 'startsWith')), !xc || xc.writable)
      );
    Oe(
    ...
    function hu() {
      ...
      return zc(r)
        ? (Object.keys(r).forEach(function (t) {
            zc(r[t])
              ? (Object.keys(e).includes(t) || Object.assign(e, ko({}, t, {})),
                hu(e[t], r[t]))
    ...
    var Cu,
      ...
      Iu = {
        ...
        check: function (e, t, n) {
          ...
          return {
            api: r,
            ui: r && Iu.rangeInput && ('video' !== e || !au.isIPhone || i),
          };
        },
        pip: !(
          au.isIPhone ||
        ...
        mime: function (e) {
          ...
          Object.keys(Pu).includes(n) && (n += '; codecs="'.concat(Pu[e], '"'));
          try {
        ...
        if (this.isHTML5) {
          ...
          (e.options.speed = e.config.speed.options),
            ...
            Object.defineProperty(e.media, 'quality', {
              ...
              set: function (t) {
                if (e.quality !== t) {
                  if (e.config.quality.forced && Yc(e.config.quality.onChange))
                    ...
                    (e.media.src = n.getAttribute('src')),
                      ('none' !== o || s) &&
                        (e.once('loadedmetadata', function () {
                          (e.speed = l), (e.currentTime = r), a || e.play();
                        }),
                        e.media.load());
                  }
                  Ru.call(e, e.media, 'qualitychange', !1, { quality: t });
                }
              },
            });
        }
    ...
    if (
      ...
      for (
        var eh = function (e, t) {
            ...
            Ju
              ? r && !a && (e = e.source)
              : e instanceof eh && (a && (t = ri.call(e)), (e = e.source)),
              Zu &&
                (n = !!t && t.indexOf('y') > -1) &&
                (t = t.replace(/y/g, ''));
    ...
    var wh = {
        ...
        try {
          return (
            ...
            (this.elements.buttons = {
              ...
              restart: Au.call(this, this.config.selectors.buttons.restart),
              rewind: Au.call(this, this.config.selectors.buttons.rewind),
              fastForward: Au.call(
                this,
              ...
              airplay: Au.call(this, this.config.selectors.buttons.airplay),
              settings: Au.call(this, this.config.selectors.buttons.settings),
              captions: Au.call(this, this.config.selectors.buttons.captions),
              fullscreen: Au.call(
                this,
            ...
            (this.elements.display = {
              buffer: Au.call(this, this.config.selectors.display.buffer),
              currentTime: Au.call(
                this,
                this.config.selectors.display.currentTime
              ),
              duration: Au.call(this, this.config.selectors.display.duration),
            }),
        ...
        return (
          a.toggle
            ? (o.appendChild(
              ...
              o.appendChild(
                wh.createIcon.call(this, a.icon, { class: 'icon--not-pressed' })
              ),
              o.appendChild(
          ...
          du(o, i),
          'play' === r
            ? (Gc(this.elements.buttons[r]) || (this.elements.buttons[r] = []),
        ...
        (f.innerHTML = a),
          ...
          this.listeners.bind(
            ...
            function (e) {
              if (!Zc(e) || 32 === e.which) {
                switch (
                  (e.preventDefault(), e.stopPropagation(), (h.checked = !0), r)
                ) {
                  case 'language':
            ...
            switch (e.type) {
              ...
              case 'seeked':
                (n = (function (e, t) {
                  ...
                  'timeupdate' === e.type &&
                    wh.setRange.call(this, this.elements.inputs.seek, n);
                break;
              case 'playing':
              case 'progress':
                !(function (e, n) {
      ...
      timeUpdate: function (e) {
        var t = !Qc(this.elements.display.duration) && this.config.invertTime;
        wh.updateTimeDisplay.call(
          this,
      ...
      setQualityMenu: function (e) {
        ...
        if (Qc(this.elements.settings.panels.quality)) {
          ...
          var i = !nu(this.options.quality) && this.options.quality.length > 1;
          if (
      ...
      toggleMenu: function (e) {
        ...
        if (Qc(t) && Qc(n)) {
          ...
          n.setAttribute('aria-expanded', r),
            wu(t, !r),
            ku(this.elements.container, this.config.classNames.menu.open, r),
            r && Zc(e)
      ...
      create: function (e) {
        ...
        return (
          Vu(this.config.controls).forEach(function (s) {
            ...
            if (
              ('captions' === s && u.appendChild(i.call(t, 'captions', h)),
              ...
              var v = pu('div', {
                ...
                y = pu('div'),
                b = pu('div', { id: 'plyr-settings-'.concat(e.id, '-home') }),
                w = pu('div', { role: 'menu' });
              b.appendChild(w),
                y.appendChild(b),
                ...
                t.config.settings.forEach(function (i) {
                  ...
                  var a = pu('span', null, uh(i, t.config)),
                    o = pu('span', { class: t.config.classNames.menu.value });
                  (o.innerHTML = e[i]),
                    a.appendChild(o),
                    r.appendChild(a),
                    w.appendChild(r);
            ...
            if (
              ('pip' === s && Iu.pip && u.appendChild(i.call(t, 'pip', h)),
              'airplay' === s &&
                Iu.airplay &&
              ...
              !tu(T) &&
                t.isEmbed &&
                hu(k, { icon: 'logo-'.concat(t.provider), label: t.provider }),
      ...
      inject: function () {
        ...
        if (
          ...
          Object.values(this.elements.buttons)
            .filter(Boolean)
            .forEach(function (e) {
              Gc(e) || Xc(e) ? Array.from(e).filter(Boolean).forEach(s) : s(e);
            });
        }
            ...
            if (
              ...
              if (
                ...
                var r = this.config.captions.update
                  ...
                  : 'removetrack';
                ju.call(this, this.media.textTracks, r, Sh.update.bind(this));
              }
        ...
        update: function () {
          ...
          this.isHTML5 &&
            ...
            ((s && this.language !== r) || !t.includes(o)) &&
              (Sh.setLanguage.call(this, r), Sh.toggle.call(this, i && s)),
            ku(
            ...
            if (Wc(e))
              if (e in n) {
                ...
                Sh.toggle.call(this, !0, t),
                  this.isHTML5 && this.isVideo && Sh.updateCues.call(this);
            ...
            if (Qc(this.elements.captions))
              if (Vc(e) || Array.isArray(e)) {
                ...
                if (i !== this.elements.captions.innerHTML) {
                  ...
                  var r = pu('span', bu(this.config.selectors.caption));
                  (r.innerHTML = i),
      ...
      jh = (function () {
        function e(t) {
          ...
          yo(this, e),
            ...
            ju.call(this, this.player.elements.container, 'keydown', function (
              e
            ) {
          ...
          wo(
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  this.enabled &&
                    (au.isIos && this.player.config.fullscreen.iosNative
              ...
              },
              {
                ...
                value: function () {
                  if (this.enabled)
                    if (au.isIos && this.player.config.fullscreen.iosNative)
              ...
              },
              {
                key: 'target',
                get: function () {
                  return au.isIos && this.player.config.fullscreen.iosNative
                    ? this.player.media
                    : this.player.elements.container;
                },
              },
                ...
                get: function () {
                  ...
                  return (
                    ['webkit', 'moz', 'ms'].some(function (t) {
                      return (
                        !(
                          !Yc(document[''.concat(t, 'ExitFullscreen')]) &&
                          !Yc(document[''.concat(t, 'CancelFullScreen')])
                        ) && ((e = t), !0)
                      );
                    }),
                    e
    ...
    var Rh = {
        ...
        build: function () {
          ...
          Qc(this.elements.controls) ||
            ...
            ku(this.elements.container, this.config.classNames.isIos, au.isIos),
            ku(
              this.elements.container,
            ...
            this.poster &&
              Rh.setPoster.call(this, this.poster, !1).catch(function () {}),
        ...
        togglePoster: function (e) {
          ku(this.elements.container, this.config.classNames.posterEnabled, e);
        },
            ...
            : (this.media.setAttribute('poster', e),
              this.isHTML5
                ...
                : Uu.call(this)
                    ...
                    .catch(function (n) {
                      throw (e === t.poster && Rh.togglePoster.call(t, !1), n);
                    })
                    .then(function () {
                      if (e !== t.poster)
                        throw new Error(
        ...
        checkPlaying: function (e) {
          ...
          ku(
            ...
            (Jc(e) && 'timeupdate' === e.type) || Rh.toggleControls.call(this);
        },
          ...
          wo(e, [
                ...
                if (
                  ...
                  if (r) {
                    ...
                    if (Qc(o)) {
                      ...
                      if (32 === e.which && Su(o, 'button, [role^="menuitem"]'))
                        return;
                    }
                    switch (
                      ([
            ...
            },
            {
              ...
              value: function () {
                ...
                t.config.keyboard.global &&
                  Lu.call(t, window, 'keydown keyup', this.handleKey, e, !1),
                  Lu.call(t, document.body, 'click', this.toggleMenu, e),
                  Nu.call(t, document.body, 'touchstart', this.firstTouch),
                  Lu.call(
                    t,
                    document.body,
                    'keydown focus blur',
            ...
            },
            {
              ...
              value: function () {
                ...
                !t.keyboard.global &&
                  t.keyboard.focused &&
                  ju.call(e, n.container, 'keydown keyup', this.handleKey, !1),
                  ju.call(
                    e,
                    n.container,
            ...
            },
            {
              ...
              value: function () {
                var e = this,
                  ...
                  n = t.elements;
                if (
                  (ju.call(t, t.media, 'timeupdate seeking seeked', function (
                    e
                  ) {
                  ...
                  var i = Au.call(t, '.'.concat(t.config.classNames.video));
                  if (!Qc(i)) return;
                ...
                t.supported.ui &&
                  ...
                  ju.call(t, t.media, 'qualitychange', function (e) {
                    wh.updateSetting.call(t, 'quality', null, e.detail.quality);
                  }),
                  ju.call(t, t.media, 'ready qualitychange', function () {
            ...
            },
            {
              ...
              value: function (e, t, n) {
                var i = this.player,
                  ...
                  a = !0;
                Yc(r) && (a = r.call(i, e)), !1 !== a && Yc(t) && t.call(i, e);
              },
            },
            {
              key: 'bind',
            ...
            },
            {
              ...
              value: function () {
                      ...
                      [13, 32].includes(n) &&
                        (13 !== n
                          ? (e.preventDefault(),
                            e.stopPropagation(),
                            wh.toggleMenu.call(t, e))
                          : wh.focusFirstMenuItem.call(t, null, !0));
                    },
                    null,
                    !1
                  ),
                ...
                this.bind(
                  ...
                  au.isWebkit &&
                    Array.from(Eu.call(t, 'input[type="range"]')).forEach(
                      function (n) {
                  ...
                  this.bind(n.controls, 'focusin', function () {
                    ...
                    ku(n.controls, i.classNames.noTransition, !0),
                      ...
                      setTimeout(function () {
                        ku(n.controls, i.classNames.noTransition, !1);
                      }, 0);
              ...
              events: {
                    ...
                    (e.options.speed = o.filter(function (t) {
                      ...
                      (e.timers.buffering = setInterval(function () {
                        (e.media.buffered = n.getVideoLoadedFraction()),
                          ...
                          1 === e.media.buffered &&
                            (clearInterval(e.timers.buffering),
                            Ru.call(e, e.media, 'canplaythrough'));
                      }, 200)),
                      setTimeout(function () {
                ...
                onStateChange: function (t) {
                  ...
                  switch (
                    ...
                    e.media.seeking &&
                      [1, 2].includes(t.data) &&
                      ((e.media.seeking = !1), Ru.call(e, e.media, 'seeked')),
                    t.data)
                  ) {
                    case -1:
                      Ru.call(e, e.media, 'timeupdate'),
          ...
          wo(e, [
            ...
            },
            {
              ...
              value: function () {
                ...
                var n = function () {
                  var t = bh(Math.max(e.manager.getRemainingTime(), 0)),
                    n = ''
                      .concat(uh('advertisement', e.player.config), ' - ')
                      .concat(t);
                  ...
                  case google.ima.AdEvent.Type.LOG:
                    r.adError &&
                      this.player.debug.warn(
                        'Non-fatal ad error: '.concat(r.adError.getMessage())
                      );
                }
              },
            },
                ...
                if (
                  ...
                  if ('touchmove' === e.type)
                    ...
                    (this.seekTime = this.player.media.duration * (n / 100)),
                      ...
                      (this.elements.thumb.time.innerText = bh(this.seekTime));
                  }
              ...
              this.destroy.call(
                ...
                function () {
                  ...
                  Object.assign(t, {
                    ...
                    t.isHTML5 && lf.insertElements.call(t, 'source', n),
          ...
          if (
            ...
            if (this.media.plyr) this.debug.warn('Target already setup');
              ...
              if (Iu.check().api) {
                ...
                switch (a) {
                  case 'div':
                    if (((o = this.media.querySelector('iframe')), Qc(o))) {
                      if (
                        ...
                        var l = ['1', 'true'];
                        l.includes(s.searchParams.get('autoplay')) &&
                  ...
                  this.supported.api
                    ? ((this.eventListeners = []),
                      ...
                      Qc(this.elements.container) ||
                        ((this.elements.container = pu('div', { tabindex: 0 })),
                      ...
                      this.config.ads.enabled && (this.ads = new Gh(this)),
                      this.isHTML5 &&
          ...
          wo(
            ...
            [
              ...
              },
              {
                key: 'airplay',
                value: function () {
                  Iu.airplay && this.media.webkitShowPlaybackTargetPicker();
                },
              },
              {
                key: 'toggleControls',
                ...
                value: function (e) {
                  ...
                  if (this.ready) {
                      ...
                      (document.body.style.overflow = ''),
                        ...
                        n
                          ? (Object.keys(t.elements).length &&
                            ...
                            Yc(e) && e())
                          : (_u.call(t),
                            yu(t.elements.original, t.elements.container),
                            Ru.call(t, t.elements.original, 'destroyed', !0),
                    ...
                    this.stop(),
                      ...
                      this.isHTML5
                        ? (Rh.toggleNativeControls.call(this, !0), i())
                        : this.isYouTube
              ...
              },
              {
                ...
                set: function (e) {
                  ...
                  Kc(t) && (t = Number(t)),
                    ...
                    (this.media.volume = t),
                    !nu(e) && this.muted && t > 0 && (this.muted = !1);
                },
                get: function () {
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? Rh.setPoster.call(this, e, !1).catch(function () {})
              ...
              },
              {
                ...
                get: function () {
                  return (Sh.getCurrentTrack.call(this) || {}).language;
                },
              },
              {
                key: 'pip',
                set: function (e) {
                  if (Iu.pip) {
                    ...
                    Yc(this.media.webkitSetPresentationMode) &&
                      this.media.webkitSetPresentationMode(t ? Ah : xh),
