  ...
  function n(t, e) {
    ...
    _classCallCheck(this, n),
      ...
      'string' == typeof t
        ...
        : (this.elements =
            void 0 !== t.length && 0 < t.length ? Array.from(t) : [t]),
      ...
      this.options.nav && this.p.a.appendChild(this.p.c),
      this.options.spinner && this.p.a.appendChild(this.p.d),
      ...
      this.options.docClose &&
        this.addEventListener(
          this.p.e,
          ['click.' + this.o, 'touchstart.' + this.o],
          function (t) {
            i.g && i.close();
          }
        ),
      this.options.disableRightClick &&
        this.addEventListener(document.body, 'contextmenu.' + this.o, function (
          t
        ) {
      ...
      this.options.enableKeyboard &&
        this.addEventListener(
          ...
          this.throttle(function (t) {
            if (((i.v.a = 0), i.h && 'Escape' === t.key))
              return i.n.setAttribute('src', ''), (i.h = !1), i.close();
            i.g &&
              (t.preventDefault(),
    ...
    _createClass(n, [
      {
        ...
        value: function () {
          (this.p.e = document.createElement('div')),
            this.p.e.classList.add('sl-overlay'),
            (this.p.e.dataset.opacityTarget = '.7'),
            ...
            this.p.d.classList.add('sl-spinner'),
            (this.p.d.innerHTML = '<div></div>'),
            (this.p.c = document.createElement('div')),
            this.p.c.classList.add('sl-navigation'),
            (this.p.c.innerHTML = '<button class="sl-prev">'
              .concat(
            ...
            this.options.className &&
              this.p.a.classList.add(this.options.className),
            this.options.rtl && this.p.a.classList.add('sl-dir-rtl');
        },
      },
      {
        key: 'throttle',
      ...
      },
      {
        ...
        value: function () {
          ...
          this.i = !0;
          var e = this.relatedElements[this.nIndex];
          for (var i in (e.dispatchEvent(new Event('close.simplelightbox')),
          this.options.history && ((this.l = !1), this.k || this.resetHash()),
          this.fadeOut(
            ...
            function () {
              t.options.disableScroll && t.toggleScrollbar('show'),
                ...
                document.body.removeChild(t.p.e),
                (t.p.i = null),
        ...
        value: function () {
          ...
          o.addEventListener('load', function (t) {
            ...
            -1 === i.q.indexOf(e) && i.q.push(e),
              i.relatedElements[n].dispatchEvent(
                new Event('nextImageLoaded.' + i.o)
              );
          }),
            o.setAttribute(
              'src',
            ...
            a.addEventListener('load', function (t) {
              ...
              -1 === i.q.indexOf(e) && i.q.push(e),
                i.relatedElements[n].dispatchEvent(
                  new Event('prevImageLoaded.' + i.o)
                );
            }),
            a.setAttribute(
              'src',
              this.relatedElements[s].getAttribute(this.options.sourceAttr)
            );
        },
      },
      {
        ...
        value: function (t) {
          ...
          this.options.rtl && (t = -t),
            this.relatedElements[this.nIndex].dispatchEvent(
              new Event('change.' + this.o)
            ),
            this.relatedElements[this.nIndex].dispatchEvent(
              new Event((1 === t ? 'next' : 'prev') + '.' + this.o)
            );
          var n = this.nIndex + t;
          if (
            this.h ||
          ...
          (this.nIndex =
            n < 0
              ...
              ? 0
              : n),
            (this.p.f.querySelector('.sl-current').innerHTML = this.nIndex + 1),
            ...
            this.fadeOut(this.p.h, 300, function () {
              (e.h = !0),
                setTimeout(function () {
                  var t = e.relatedElements[e.nIndex];
                  e.n.setAttribute('src', t.getAttribute(e.options.sourceAttr)),
                    -1 === e.q.indexOf(t.getAttribute(e.options.sourceAttr)) &&
                      e.show(e.p.d),
                    e.p.h.contains(e.p.g) && e.p.h.removeChild(e.p.g),
                    e.adjustImage(i),
        ...
        value: function (a) {
          ...
          t.setAttribute('src', this.n.getAttribute('src')),
            ...
            t.addEventListener('error', function (t) {
              r.relatedElements[r.nIndex].dispatchEvent(
                new Event('error.' + r.o)
              ),
                (r.h = !1),
                (r.g = !1),
                (r.p.d.style.display = 'none');
              var e = 1 === a || -1 === a;
            ...
            t.addEventListener('load', function (t) {
              void 0 !== a &&
                (r.relatedElements[r.nIndex].dispatchEvent(
                  new Event('changed.' + r.o)
                ),
                r.relatedElements[r.nIndex].dispatchEvent(
                  new Event((1 === a ? 'nextDone' : 'prevDone') + '.' + r.o)
                )),
                r.options.history && r.updateURL(),
                -1 === r.q.indexOf(r.n.getAttribute('src')) &&
                  r.q.push(r.n.getAttribute('src'));
              ...
              var s,
                o =
                  'self' === r.options.captionSelector
                    ? r.relatedElements[r.nIndex]
                    : r.relatedElements[r.nIndex].querySelector(
              ...
              r.options.captions &&
                ...
                (s =
                  'data' === r.options.captionType
                    ? o.dataset[r.options.captionsData]
                    : 'text' === r.options.captionType
                    ? o.innerHTML
                    : o.getAttribute(r.options.captionsData)),
                r.options.loop ||
                  (0 === r.nIndex && r.hide(r.p.c.querySelector('.sl-prev')),
                  r.nIndex >= r.relatedElements.length - 1 &&
                    r.hide(r.p.c.querySelector('.sl-next')),
                  0 < r.nIndex && r.show(r.p.c.querySelector('.sl-prev')),
                  r.nIndex < r.relatedElements.length - 1 &&
                    r.show(r.p.c.querySelector('.sl-next'))),
                1 === r.relatedElements.length
                  ? r.hide(r.p.c.querySelectorAll('.sl-prev, .sl-next'))
                  : r.show(r.p.c.querySelectorAll('.sl-prev, .sl-next')),
                1 === a || -1 === a
                ...
                r.options.additionalHtml &&
                  !r.p.i &&
                  ((r.p.i = document.createElement('div')),
      ...
      },
      {
        ...
        value: function (t, e, i) {
          this.n.style[this.b + 'transform'] =
            'translate(' + t + ',' + e + ') scale(' + i + ')';
        },
      },
      {
        key: 'minMax',
      ...
      },
      {
        ...
        value: function () {
          ...
          this.addEventListener(window, 'resize.' + this.o, function (t) {
            ...
            this.addEventListener(
              this.p.c.getElementsByTagName('button'),
              'click.' + this.o,
              function (t) {
                ...
                t.preventDefault(),
                  (i.v.a = 0),
                  i.loadImage(
                    t.currentTarget.classList.contains('sl-next') ? 1 : -1
                  );
              }
            ),
            this.addEventListener(
              this.p.h,
              ['touchstart.' + this.o, 'mousedown.' + this.o],
              function (t) {
                ...
                if ('mousedown' === t.type)
                  ...
                  if (
                      ...
                      return (
                        ...
                        i.v.i
                          ? ((i.v.w = 1),
                            ...
                            (i.v.i = !1))
                          : ((i.v.w = i.options.doubleTapZoom),
                            i.setZoomData(i.v.w, 0, 0),
                            i.zoomPanElement('0px', '0px', i.v.w),
                            i.p.g.style.opacity ||
                              'none' === i.p.g.style.display ||
                              i.fadeOut(i.p.g, 200),
                            (i.v.i = !0)),
                        setTimeout(function () {
                    ...
                    2 === i.v.L &&
                      ...
                      (i.v.x = Math.sqrt(
                        (i.v.s - i.v.s2) * (i.v.s - i.v.s2) +
                          (i.v.t - i.v.t2) * (i.v.t - i.v.t2)
                      )));
                  i.v.p = !0;
                }
                return (
                  !!i.v.g ||
                  (i.c && (i.v.h = parseInt(i.p.h.style.left, 10)),
                  (i.v.g = !0),
                  (i.v.a = 0),
                  (i.v.b = 0),
            ...
            this.addEventListener(
              this.p.h,
              ['touchmove.' + this.o, 'mousemove.' + this.o, 'MSPointerMove'],
              function (t) {
                if (!i.v.g) return !0;
                if ((t.preventDefault(), 'touchmove' === t.type)) {
                  ...
                  (i.v.y = t.touches[0].clientX),
                    ...
                    i.v.N++,
                    1 < i.v.L
                      ? ((i.v.y2 = t.touches[1].clientX),
                        (i.v.z2 = t.touches[1].clientY),
                        (i.v.K = Math.sqrt(
                          (i.v.y - i.v.y2) * (i.v.y - i.v.y2) +
                            (i.v.z - i.v.z2) * (i.v.z - i.v.z2)
                        )),
                        null === i.v.x && (i.v.x = i.v.K),
                        1 <= Math.abs(i.v.x - i.v.K) &&
                          ((i.v.E = i.minMax(
                            (i.v.K / i.v.x) * i.v.w,
                            1,
                            i.options.maxZoom
                      ...
                      : ((i.v.E = i.v.w),
                        ...
                        Math.abs(i.v.C) === Math.abs(i.v.H) &&
                          ((i.v.q = i.v.C), (i.v.s = i.v.y)),
                        Math.abs(i.v.D) === Math.abs(i.v.I) &&
                          ((i.v.r = i.v.D), (i.v.t = i.v.z)),
                ...
                if ('mousemove' === t.type && i.v.g) {
                  ...
                  (i.v.y = t.clientX),
                    ...
                    (i.v.C =
                      i.v.o * i.v.E <= i.v.k
                        ? 0
                        : i.minMax(i.v.y - (i.v.s - i.v.q), -1 * i.v.H, i.v.H)),
                    (i.v.D =
                      i.v.n * i.v.E <= i.v.j
                        ? 0
                        : i.minMax(i.v.z - (i.v.t - i.v.r), -1 * i.v.I, i.v.I)),
                    Math.abs(i.v.C) === Math.abs(i.v.H) &&
                      ((i.v.q = i.v.C), (i.v.s = i.v.y)),
                    Math.abs(i.v.D) === Math.abs(i.v.I) &&
                      ((i.v.r = i.v.D), (i.v.t = i.v.z)),
                ...
                i.v.i ||
                  ((i.v.d = t.pageX || t.touches[0].pageX),
            ...
            this.addEventListener(
              ...
              function (t) {
                if (
                  ...
                  var e = !(i.v.g = !1);
                  i.options.loop ||
                    (0 === i.nIndex && i.v.a < 0 && (e = !1),
                    i.nIndex >= i.relatedElements.length - 1 &&
                      0 < i.v.a &&
                      (e = !1)),
                    Math.abs(i.v.a) > i.options.swipeTolerance && e
                      ? i.loadImage(0 < i.v.a ? 1 : -1)
                      : i.options.animationSlide &&
                        i.slide(i.options.animationSpeed / 1e3, '0px'),
                    i.options.swipeClose &&
                      50 < Math.abs(i.v.b) &&
                      Math.abs(i.v.a) < i.options.swipeTolerance &&
                      i.close();
                }
              }
            ),
      ...
      },
      {
        ...
        value: function () {
          ...
          (this.k = !1),
            this.f
              ? window.history[this.l ? 'replaceState' : 'pushState'](
                  '',
                  document.title,
                  e
                )
      ...
      },
      {
        ...
        value: function () {
          clearTimeout(this.m),
            this.l
              ? (this.m = setTimeout(this.updateHash.bind(this), 800))
              : this.updateHash();
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t, e) {
          ...
          (this.p.h.style[this.b + 'transform'] = 'translateX(' + e + ')'),
            (this.p.h.style[this.b + 'transition'] =
              this.b + 'transform ' + t + 's linear');
        },
      },
      {
        key: 'getRelated',
        ...
        value: function (t) {
          ...
          t.dispatchEvent(new Event('show.' + this.o)),
            this.options.disableScroll &&
              (this.u = this.toggleScrollbar('hide')),
            ...
            this.options.overlay && document.body.appendChild(this.p.e),
            (this.relatedElements = this.getRelated(t.rel)),
            this.options.showCounter &&
              (1 == this.relatedElements.length && this.p.a.contains(this.p.f)
                ? this.p.a.removeChild(this.p.f)
                : 1 < this.relatedElements.length &&
                  !this.p.a.contains(this.p.f) &&
                  this.p.a.appendChild(this.p.f)),
            (this.h = !0),
            (this.nIndex = this.relatedElements.indexOf(t));
          ...
          (this.n = document.createElement('img')),
            ...
            this.fadeIn(this.p.e, 300),
            this.fadeIn([this.p.f, this.p.c, this.p.b], 300),
            this.show(this.p.d),
            (this.p.f.querySelector('.sl-current').innerHTML = this.nIndex + 1),
            (this.p.f.querySelector(
              '.sl-total'
              ...
              try {
                for (l.s(); !(r = l.n()).done; ) {
                  var h = r.value,
                    v = n || !1;
                  (a.namespaces[h] = i),
                    a.addEventListener(h.split('.')[0], i, v);
                }
              } catch (t) {
                l.e(t);
              } finally {
          ...
          try {
            for (n.s(); !(i = n.n()).done; ) {
              ...
              try {
                for (a.s(); !(s = a.n()).done; ) {
                  var r = s.value;
                  o.removeEventListener(r.split('.')[0], o.namespaces[r]),
                    delete o.namespaces[r];
                }
              } catch (t) {
                a.e(t);
              } finally {
      ...
      },
      {
        ...
        value: function (r, t, l) {
          var e,
            h = this,
            i = _createForOfIteratorHelper((r = this.wrap(r)));
          try {
            for (i.s(); !(e = i.n()).done; ) {
          ...
          !(function t() {
            ...
            if ((e -= v) < 0) {
              ...
              try {
                for (n.s(); !(i = n.n()).done; ) {
                  var s = i.value;
                  (s.style.display = 'none'), (s.style.opacity = '');
                }
              } catch (t) {
                n.e(t);
              } finally {
              ...
              var o,
                a = _createForOfIteratorHelper(r);
              try {
                for (a.s(); !(o = a.n()).done; ) {
                  o.value.style.opacity = e;
                }
              } catch (t) {
                a.e(t);
              } finally {
      ...
      },
      {
        ...
        value: function (a, t, r, e) {
          var i,
            l = this,
            n = _createForOfIteratorHelper((a = this.wrap(a)));
          try {
            for (n.s(); !(i = n.n()).done; ) {
              var s = i.value;
              (s.style.opacity = 0), (s.style.display = e || 'block');
            }
          } catch (t) {
            n.e(t);
          } finally {
          ...
          var h = parseFloat(a[0].dataset.opacityTarget || 1),
            v = (16.66666 * h) / (t || 300);
          !(function t() {
            var e = parseFloat(a[0].style.opacity);
            if ((e += v) > h) {
              var i,
                n = _createForOfIteratorHelper(a);
              try {
                for (n.s(); !(i = n.n()).done; ) {
                  i.value.style.opacity = '';
                }
              } catch (t) {
                n.e(t);
              } finally {
      ...
      },
      {
        ...
        value: function (t) {
          var e,
            i = _createForOfIteratorHelper((t = this.wrap(t)));
          try {
            for (i.s(); !(e = i.n()).done; ) {
              var n = e.value;
      ...
      },
      {
        ...
        value: function (t, e) {
          var i,
            n = _createForOfIteratorHelper((t = this.wrap(t)));
          try {
            for (n.s(); !(i = n.n()).done; ) {
              var s = i.value;
      ...
      },
      {
        ...
        value: function (t, e) {
          t = this.wrap(t);
          var i,
            n = _createForOfIteratorHelper(this.elements);
          try {
            for (n.s(); !(i = n.n()).done; ) {
              var s = i.value;
      ...
      },
      {
        ...
        value: function (t) {
          t = this.wrap(t);
          var e,
            i = _createForOfIteratorHelper(this.elements);
          try {
            for (i.s(); !(e = i.n()).done; ) {
              var n,
                s = e.value,
              ...
              try {
                for (o.s(); !(n = o.n()).done; ) {
                  ...
                  void 0 !== s.fullyNamespacedEvents &&
                    a in s.fullyNamespacedEvents &&
                    s.removeEventListener(a, s.fullyNamespacedEvents[a]);
                }
              } catch (t) {
                o.e(t);
              } finally {
      ...
      },
      {
        ...
        value: function () {
          this.off([
            'close.' + this.o,
            'closed.' + this.o,
            'nextImageLoaded.' + this.o,
            'prevImageLoaded.' + this.o,
            'change.' + this.o,
            'nextDone.' + this.o,
            'prevDone.' + this.o,
            'error.' + this.o,
            ...
            this.close(),
            this.g &&
              (document.body.removeChild(this.p.a),
              document.body.removeChild(this.p.e)),
            (this.elements = null);
        },
      },
      {
