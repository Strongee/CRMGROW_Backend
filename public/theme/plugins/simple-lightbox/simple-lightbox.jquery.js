    ...
    },
    {
      ...
      value: function preload() {
        ...
        nextImage.setAttribute(
          'src',
          this.relatedElements[next].getAttribute(this.options.sourceAttr)
        );
        ...
        prevImage.setAttribute(
          'src',
          this.relatedElements[prev].getAttribute(this.options.sourceAttr)
        );
      },
    },
    {
      ...
      value: function loadImage(direction) {
        ...
        this.relatedElements[this.currentImageIndex].dispatchEvent(
          new Event(
            (direction === 1 ? 'next' : 'prev') + '.' + this.eventNamespace
          )
        );
        ...
        if (
          this.isAnimating ||
          ((newIndex < 0 || newIndex >= this.relatedElements.length) &&
        ...
        if (this.options.animationSlide) {
          this.slide(
            ...
            -100 * slideDirection - this.controlCoordinates.swipeDiff + 'px'
          );
        }
    ...
    },
    {
      ...
      value: function adjustImage(direction) {
        ...
        tmpImage.addEventListener('error', function (event) {
          _this5.relatedElements[_this5.currentImageIndex].dispatchEvent(
        ...
        tmpImage.addEventListener('load', function (event) {
          ...
          _this5.domNodes.image.style.left =
            (window.innerWidth - imageWidth - _this5.globalScrollbarWidth) / 2 +
            'px';
          ...
          if (_this5.options.captions && captionContainer) {
            if (_this5.options.captionType === 'data') {
              captionText =
                captionContainer.dataset[_this5.options.captionsData];
          ...
          if (_this5.relatedElements.length === 1) {
            _this5.hide(
              _this5.domNodes.navigation.querySelectorAll('.sl-prev, .sl-next')
            );
          } else {
            _this5.show(
              _this5.domNodes.navigation.querySelectorAll('.sl-prev, .sl-next')
      ...
      value: function addEvents() {
        ...
        this.addEventListener(
          ...
          function (event) {
            ...
            _this6.loadImage(
              event.currentTarget.classList.contains('sl-next') ? 1 : -1
            );
          }
        );
        this.addEventListener(
          ...
          function (event) {
            ...
            if (event.type === 'mousedown') {
              ...
              _this6.controlCoordinates.containerHeight = _this6.getDimensions(
                _this6.domNodes.image
              ).height;
              _this6.controlCoordinates.containerWidth = _this6.getDimensions(
                _this6.domNodes.image
              ).width;
              _this6.controlCoordinates.imgHeight = _this6.getDimensions(
                _this6.currentImage
              ).height;
              _this6.controlCoordinates.imgWidth = _this6.getDimensions(
                _this6.currentImage
              ).width;
              ...
              if (_this6.controlCoordinates.touchCount === 1) {
                ...
                _this6.controlCoordinates.pinchOffsetY =
                  (_this6.controlCoordinates.initialPointerOffsetY +
                    _this6.controlCoordinates.initialPointerOffsetY2) /
                  2;
                _this6.controlCoordinates.initialPinchDistance = Math.sqrt(
                  (_this6.controlCoordinates.initialPointerOffsetX -
                    _this6.controlCoordinates.initialPointerOffsetX2) *
                    (_this6.controlCoordinates.initialPointerOffsetX -
                      _this6.controlCoordinates.initialPointerOffsetX2) +
            ...
            if (event.type === 'touchmove') {
              ...
              if (_this6.controlCoordinates.touchCount > 1) {
                ...
                _this6.controlCoordinates.pointerOffsetY2 =
                  event.touches[1].clientY;
                _this6.controlCoordinates.targetPinchDistance = Math.sqrt(
                  (_this6.controlCoordinates.pointerOffsetX -
                    _this6.controlCoordinates.pointerOffsetX2) *
                    (_this6.controlCoordinates.pointerOffsetX -
                      _this6.controlCoordinates.pointerOffsetX2) +
                ...
                if (
                  ...
                  /* Initialize helpers */
                  _this6.controlCoordinates.targetScale = _this6.minMax(
                    (_this6.controlCoordinates.targetPinchDistance /
                      _this6.controlCoordinates.initialPinchDistance) *
                      _this6.controlCoordinates.initialScale,
                    1,
                    ...
                    _this6.controlCoordinates.containerWidth
                      ...
                      : _this6.minMax(
                          _this6.controlCoordinates.initialOffsetX -
                            ((_this6.controlCoordinates.pinchOffsetX -
                              _this6.controlCoordinates.containerOffsetX -
                              _this6.controlCoordinates.containerWidth / 2 -
                              _this6.controlCoordinates.initialOffsetX) /
                              (_this6.controlCoordinates.targetScale -
                                _this6.controlCoordinates.scaleDifference)) *
                              _this6.controlCoordinates.scaleDifference,
                    ...
                    _this6.controlCoordinates.containerHeight
                      ...
                      : _this6.minMax(
                          _this6.controlCoordinates.initialOffsetY -
                            ((_this6.controlCoordinates.pinchOffsetY -
                              _this6.controlCoordinates.containerOffsetY -
                              _this6.controlCoordinates.containerHeight / 2 -
                              _this6.controlCoordinates.initialOffsetY) /
                              (_this6.controlCoordinates.targetScale -
                                _this6.controlCoordinates.scaleDifference)) *
                              _this6.controlCoordinates.scaleDifference,
                ...
                if (
                  Math.abs(_this6.controlCoordinates.targetOffsetX) ===
                ...
                if (
                  Math.abs(_this6.controlCoordinates.targetOffsetY) ===
          ...
          function (event) {
            ...
            if (_this6.controlCoordinates.mousedown) {
              ...
              if (
                ...
                Math.abs(_this6.controlCoordinates.swipeYDiff) > 50 &&
                Math.abs(_this6.controlCoordinates.swipeDiff) <
                  _this6.options.swipeTolerance
              ) {
                _this6.close();
        ...
        this.addEventListener(this.domNodes.image, ['dblclick'], function (
          event
        ) {
          ...
          for (_iterator15.s(); !(_step15 = _iterator15.n()).done; ) {
            ...
            try {
              for (_iterator16.s(); !(_step16 = _iterator16.n()).done; ) {
                ...
                if (
                  typeof element.fullyNamespacedEvents !== 'undefined' &&
