...
const sendVideo = async (req, res) => {
  ...
  const msg = {
    ...
    subject: subject,
    html: '<html><head><title>Video Invitation</title></head><body><p style="white-space: pre-wrap;">' + content + '</p><a href="' + video_link + '"><img src="'+API_URL+video_preview+'?resize=true"/></a><br/><a href="' + video_link + '"><img src="'+urls.ASSETS_URL+'images/play-button.png"/></a><br/><br/>Thank you<br/><br/>'+ currentUser.email_signature + '</body></html>'
  }
