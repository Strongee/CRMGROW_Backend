...
const sendVideo = async (req, res) => {
  ...
  const msg = {
    ...
    subject: subject,
    html: '<html><head><title>Video Invitation</title></head><body><p style="white-space: pre-wrap;">' + content + '</p><a href="' + video_link + '" style="position:relative;height:140px;width:250px;display:block;"><img src="'+video_preview+'?resize=true"/><img src="'+urls.ASSETS_URL+'images/play-button.png" style="position:absolute;bottom:0px;display:block;left:0px;"/></a><br/><br/>Thank you<br/><br/>'+ currentUser.email_signature + '</body></html>'
  }
