const config = {
    AWS: {
        AWS_ACCESS_KEY: process.env.AWS_ACCESS_KEY || 'AKIAJ77XFUWEEZVAJF3QE',
        AWS_SECRET_ACCESS_KEY: process.env.AWS_SECRET_ACCESS_KEY || '0FSDM2WZFTPZ+LPucbTc4RD03E3Yys4phwhsU3AvF',
