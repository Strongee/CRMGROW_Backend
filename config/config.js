const config = {
    AWS: {
        AWS_ACCESS_KEY: process.env.AWS_ACCESS_KEY || 'AKRBKIAJ77XFUWEEZVAJF3Q',
        AWS_SECRET_ACCESS_KEY: process.env.AWS_SECRET_ACCESS_KEY || '0FKRBSDM2WZFTPZ+LPucbTc4RD03E3Yys4phwhsU3Av',
    ...
    SENDGRID: {
        SENDGRID_KEY: process.env.SENDGRID_KEY || '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',
    ...
    TWILIO: {
        ...
        TWILIO_AUTH_TOKEN: process.env.TWILIO_AUTH_TOKEN || 'd67f2fe5d3fbfd565b21285f37279372',
